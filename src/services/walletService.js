      ...
      [
        {
          ...
          contest,
          team,
          openingBalance: user.coins + debitAmount,
      ...
      [
        {
          ...
          contest,
          team,
          openingBalance: Math.max(0, user.coins - creditAmount),
          balanceAfter: user.coins,
          metadata,
          ...(idempotencyKey ? { idempotencyKey } : {}),
        },
      ...
      [
        {
          ...
          team,
          withdrawal,
          openingBalance: Math.max(0, user.winningCoins - creditAmount),
      ...
      [
        {
          ...
          reason,
          withdrawal,
          openingBalance: user.winningCoins + debitAmount,
          balanceAfter: user.winningCoins,
          metadata: { ...metadata, wallet: 'winning' },
          ...(idempotencyKey ? { idempotencyKey } : {}),
        },
